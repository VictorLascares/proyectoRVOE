...
@endsection
@section('contenido')
    <form id="status-form" class="flex flex-col items-end gap-2" action="{{ route('requisitions.update', $data->id) }}"
        method="POST">
        @method('PUT')
        @csrf
        <select id="status-select" name="estado" class="border-gray-200 rounded-xl">
        ...
        <div class="my-10">
            ...
            <div class="flex flex-col items-start gap-4 mt-5">
                ...
                @if ($data->opinionFormat)
                    <a id="open-img" class="text-green-900 hover:text-green-700 hover:underline"

        ...
        <div class="card-body">
          <form method="POST" action="{{ route('institutions.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
              <input required type="text" class="form-control" id="institutionName"
                placeholder="Nombre de la Institución" name="nombre">
              <label for="institutionName">Nombre de la Institución</label>
            </div>
            <div class="form-floating mb-3">
              <input required type="text" class="form-control" id="nameDirectorInstitution"
                placeholder="Nombre del Director" name="director">

        ...
        <form method="POST" action="{{ route('users.store') }}" novalidate>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" class="w-full border p-3  @error('name') border-red-600 @enderror" id="name" name="name" placeholder="Nombre">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="email" class="w-full border p-3  @error('email') border-red-600 @enderror" id="email" name="email" placeholder="Correo Electronico">
                    @error('email')
                        <p class="text-red-600 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" name="telefono" class="w-full border p-3  @error('telefono') border-red-600 @enderror" id="telefono" placeholder="Número de telefono">
                    @error('telefono')
                        <p class="text-red-600 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex justify-end mt-4">
                <button type="submit" class="bg-[#13322B] hover:bg-[#0C231E] p-3 text-white  transition-colors w-full md:w-auto">Crear Usuario</button>
            </div>
        </form>
    </div>
</div>

...
<div class="container mb-5 mt-4 pb-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="col-md-6">
                <div class="form-floating mb-2">
                    ...
                    <input name="name" type="text" class="w-full border p-3" id="careerName" placeholder="Nombre de la Carrera" value="{{ $career->name }}">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    ...
                    <select id="careerModality" class="w-full border p-3" name="modality" required>
                        <option selected disabled>-- Seleccione la Modalidad --</option>
                        <option value="Escolarizado" @if ($career->modality == 'Escolarizado') selected @endif>Escolarizado</option>
                        <option value="Semiescolarizado" @if ($career->modality == 'Semiescolarizado') selected @endif>Semiescolarizado</option>
                        <option value="No escolarizado" @if ($career->modality == 'No escolarizado') selected @endif>No escolarizado</option>
            ...
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <label for="careerPeriod" class="mb-2 block uppercase text-gray-500 font-bold">Tipo de periodo</label>
                    <select id="careerPeriod" class="w-full border p-3" name="typeOfPeriod" required>
                        ...
                        <option value="Cuatrimestral" @if ($career->typeOfPeriod == 'Cuatrimestral') selected @endif>Cuatrimestral</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-floating">
                    ...
                    <input type="text" class="w-full border p-3" name="duration" value="{{ $career->numOfPeriods }}" id="careerDuration" placeholder="Duración de la Carrera">
                </div>
            </div>
        </div>
    ...
    <section class="mt-4">
        <div class="flex justify-between items-center mb-4">
            ...
            @if (Auth::user()->tipoUsuario !== 'direccion')
            <button type="button" data-modal-toggle="new-request" type="submit" class="bg-[#13322B] hover:bg-[#0C231E] text-white py-2 px-4">
                Nueva Solicitud
            </button>
            @endif
        </div>
